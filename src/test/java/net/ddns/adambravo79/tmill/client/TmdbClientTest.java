...
class TmdbClientTest {
  ...
  void devePesquisarFilmeComSucesso() {
    var filme =
        new MovieRecord(
            1L, "Dune", "2021-10-01", "overview", 99.0, 8.5, "/poster.jpg", List.of("US"));
  ...
  void deveBuscarDetalhesComSucesso() {
    var movie =
        new MovieRecord(
            2L, "Batman", "2022-03-01", "overview", 88.0, 7.9, "/poster.jpg", List.of("US"));
  ...
  void deveBuscarOndeAssistirComSucesso() {
    var response =
        new WatchProviderResponse(
            Map.of("BR", new CountryProviders(List.of(new Provider("Netflix", 1, "/logo.png")))));
