 ...
 *
 * ATUALIZADO: Agora usa BiConsumer<String, Boolean> como callback:
 *   - O primeiro parâmetro é o texto da mensagem a enviar.
 *   - O segundo (isUltimaMensagem) indica se é a mensagem final da transcrição,
 *     momento em que o TelegramController deve anexar os botões de ação.
 */
@Log4j2
@Service
...
public class AudioPipelineService {
    ...
    private final AudioService audioService; // Conversão local FFmpeg 
    private final GroqClient groqClient; // API Groq
