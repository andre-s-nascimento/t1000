# 📊 Guia de Logging Estruturado - Tmill

Este documento faz parte do **Dev Guide** e define as práticas recomendadas para logs no projeto **Tmill**.
...
5. **Mensagens consistentes**
   ...
   - Exemplo:  
     `"Erro ao publicar no Blogger blogId={} title={}"`.
...
Seguindo estas práticas, os logs do projeto **Tmill** permanecem claros, úteis e consistentes, facilitando a análise e manutenção.
